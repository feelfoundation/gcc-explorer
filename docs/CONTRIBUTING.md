...
This section guides you through submitting a bug report for gcc-explorer.
...
* **Did the problem start happening recently** (e.g. after updating to a new
	version of gcc-explorer, Feel or any other repository) or was this always a
	problem?
* If the problem started happening recently, **can you reproduce the problem in
	an older version of gcc-explorer?** What’s the most recent version in which
	the problem doesn’t happen? You can download older versions of gcc-explorer
	from [the releases page](https://github.com/feelfoundation/gcc-explorer/releases).
...
gcc-explorer, including completely new features and minor improvements to
...
* **Include screenshots and animated GIFs** which help you demonstrate the steps
	or point out the part of gcc-explorer which the suggestion is related to. You
...
* **Explain why this enhancement would be useful** to most Feel and
	gcc-explorer users.
* **Specify which version of Feel and gcc-explorer you’re using.**
...
On gcc-explorer we are using [Prettier](https://prettier.io/) and
