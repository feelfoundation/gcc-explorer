Feature: Block page
  Scenario: should show title, summary, and transactions
    ...
    And I should see table "transactions table" with 20 rows starting with:
      ...
      |----------------------|---------------------------|----------------------|-----------------------|-----------------|-------|---------------|
      | /\d{18,20}/          | /2016\/05\/24 \d\d:00:00/ | 1085993630748340485L | 16313739661670634666L	| 100,000,000 GCC | 0 GCC | Confirmed     |
      | /\d{18,20}/          | /2016\/05\/24 \d\d:00:00/ | /genesis_\d{1,3}/    | Delegate registration | 0 GCC           | 0 GCC | Confirmed     |
      | /\d{18,20}/          | /2016\/05\/24 \d\d:00:00/ | /genesis_\d{1,3}/    | Delegate registration | 0 GCC           | 0 GCC | Confirmed     |
      | /\d{18,20}/          | /2016\/05\/24 \d\d:00:00/ | /genesis_\d{1,3}/    | Delegate registration | 0 GCC           | 0 GCC | Confirmed     |
      | /\d{18,20}/          | /2016\/05\/24 \d\d:00:00/ | /genesis_\d{1,3}/    | Delegate registration | 0 GCC           | 0 GCC | Confirmed     |
